...
public class Client implements Runnable {
	...
	private LinkedBlockingQueue<String> queueToUser =
		new LinkedBlockingQueue<>();
	private LinkedBlockingQueue<String> queueToServer =
		new LinkedBlockingQueue<>();
	...
	/**
	 * Creates a new thread for this class, makes it a daemon thread, and calls
	 * it's run() method.
	 */
	public void setup() {
